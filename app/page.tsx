  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow">
        {/* Main Visual / Hero - Mimicking the clean banner style */}
        <section className="bg-[#e6f7ff] py-16 md:py-24 border-b border-gray-100">
          <div className="site-container">
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="md:w-1/2 text-center md:text-left space-y-6">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0056b3] leading-tight">
                  お金の知識は<br />
                  人生を変える
                </h1>
                <p className="text-gray-700 text-lg leading-relaxed">
                  正しい知識とマインドセットで、<br />
                  あなたの経済的な自立と自由をサポートします。<br />
                  初心者から始められる、実践的なガイド。
                </p>
                <div className="pt-4">
                  <Link
                    href="/start"
                    className="inline-block bg-[#00a0e9] text-white px-8 py-3 rounded-full font-bold hover:bg-[#008bc9] transition-colors shadow-sm"
                  >
                    まずはここから
                  </Link>
                </div>
              </div>
              {/* Placeholder for a professional illustration/image */}
              <div className="md:w-1/2 flex justify-center">
                <div className="w-full max-w-md aspect-video bg-white rounded-xl shadow-sm border border-gray-100 flex items-center justify-center text-gray-400">
                  <span className="text-sm">メインビジュアル</span>
                </div>
              </div>
            </div>
          </div>
